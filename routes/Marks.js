...
// const formatAssignmentData = (userMarks) => {
//     const assignments = Object.keys(userMarks).map((userId) => ({
//         user_id: userId,
//         marks: userMarks[userId].map((mark) => ({
//             gr: mark.gr,
//             mk: mark.mk,
//             tm: mark.tm,
//             pt: mark.pt,
...
//             const uniqueUserIds = new Set(users.map((user) => user[0]));

//             const assignments = formatAssignmentData(userMarks);
...
//                 class_report: {
//                     column_headers: [
//                         [class_id, 'Assignment 1', 5],
//                         [class_id + 1, 'Assignment 2', 5],
//                         [-1, 'Grand Total', -1],
//                     ],
//                     title_colspan: [
//                         { id: class_id, name: 'Assignment 1', colspan: 1 },
//                         { id: class_id + 1, name: 'Assignment 2', colspan: 1 },
//                         { name: '', colspan: 1 },
//                     ],
//                     points: ['5', '5', 10],
//                     user_marks: assignments,
//                     users: users.map((user) => [user[0], user[1], user[2]]),
//                 },
//             };

//             // Save formattedResponse to the database using Sequelize
